...
//
// This program draws three identical-looking
// circular annuluses in three different ways -
// see comments below.
//
// Interaction:
// Press the space bar to toggle between wireframe
// and filled for the lower annulus.
//
// Sumanta Guha.
/////////////////////////////////////////////////////
...
// Function to draw a disc with center at (X, Y, Z),
// radius R, parallel to the
// xy-plane.
...
void drawScene(void)
{
   ...
   // glEnable(GL_DEPTH_TEST);                                          // the depth buffer.
   ...
   // Upper right circular annulus: the white disc is
   // in front of the green disc blocking it.
...
int main(int argc, char **argv)
{
   printInteraction();
   glutInit(&argc, argv);
   glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGB | GLUT_DEPTH); // Initialize the buffers
